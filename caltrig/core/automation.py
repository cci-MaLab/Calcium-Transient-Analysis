...
from .automation_grid import (expand_parameters, generate_combination_folder_name,
                              save_combination_manifest)
...
def load_parameters(parameter_file: str) -> dict:
    ...
    Parameters can be single values or lists. When lists are provided,
    the automation system will generate all combinations (grid search).
    ...
    params : dict
        ...
        Parameter values can be single values or lists for grid search.
        
    Notes
    -----
    Grid search is automatically enabled when any parameter is a list with
    multiple values. The system will create separate output folders for
...
def run_batch_automation(session_paths: list, parameter_file: str, output_path: str = None,
    ...
    Supports grid search: if any parameter in the JSON is a list with multiple values,
    the system will automatically generate all combinations and create separate output
    ...
    parameter_file : str
        Path to JSON file containing analysis parameters.
        Parameters can be single values or lists for grid search.
